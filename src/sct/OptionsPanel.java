...
public class OptionsPanel extends JPanel {
	...
	//
	public OptionsPanel(Panel w, int new_panel_type) {
		parent = w;
	...
	public void paintComponent(Graphics canvas) {
		...
		canvas.drawString(String.valueOf(parent.options_panel_index + 1) + "/" + String.valueOf(parent.options_panels.length), 140, 1000);
		if (panel_type == 0) {
